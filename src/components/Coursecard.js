    ...
    <>
        <div className="card-1 cards">
            ...
            <div className="pack-info">
                ...
                {/* <div className="package-for">Ideal solution for beginners</div> */}


                <div className="pricing">
                    {/* <div className="discount">
                        <span className="text-strike">₹399</span>
                        <span className="save-percentage">Save 83%</span>
                    </div> */}
                    <div className="price">
            ...
            <div className="features">
                {/* <h3 className="feature-list-title">Top features comparison</h3> */}
